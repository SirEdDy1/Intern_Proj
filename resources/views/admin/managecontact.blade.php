...
<head>
  ...
  <title>Trang Quản lý liên lạc</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>QL</b>DL</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg">Quản lý<b>Dữ liệu</b></span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <!-- search form -->
      <form action="{{route('admin.contact.search')}}" method="get" class="sidebar-form">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Liên Lạc</h3>
